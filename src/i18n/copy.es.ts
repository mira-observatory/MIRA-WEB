export const copyEs = {
  ...
  columns: {
    ...
    total_awarded_amount: "Monto acumulado adjudicado",
    award_count: "Adjudicaciones",
    shared_award_count: "Adjudicaciones compartidas",
    refreshed_at: "Actualizado al",
    ...
    award_status: "Estado de la adjudicación",
    normalisation_status: "Estado de validación",
    is_valid_award: "Adjudicación válida",
